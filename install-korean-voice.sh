...
#   2) 한국어 안내 음성 조각 163개 생성  <- 여기서만 인터넷/TTS 를 씁니다
...
#------------------------------------------------------------------------------
log "2/4  한국어 안내 음성 만들기 (163개, 몇 분 걸립니다)"
#------------------------------------------------------------------------------
...
echo "  조각 ${N}/163 개 (8kHz) + ${N16}/163 개 (16kHz)"
(( N16 >= 163 )) || warn "16kHz 판이 부족합니다. G.722 통화에서 소리가 뭉개질 수 있습니다"
(( N >= 163 )) || warn "조각이 부족합니다. 부족한 시각은 안내가 조용할 수 있습니다"
...
===========================================================================
 ...
 확인
   ...
   ls /var/lib/asterisk/sounds/custom/bank/*.wav | wc -l   # 163 이어야 합니다
   ls /var/lib/asterisk/sounds/custom/bank/*.wav16 | wc -l # 163 (16kHz 판)
