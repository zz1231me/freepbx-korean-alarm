...
#
#   목소리: 기본 coral(따뜻·친근). --voice cedar / marin ... 로 바꿀 수 있습니다.
#
...
TTS="gtts"
VOICE="${TTS_VOICE:-coral}"   # 따뜻하고 친근한 목소리(cedar 는 편차 큼)
 ...
 사용  —  7000 하나만 기억하시면 됩니다
   7000 -> "시간 알림 써비스입니다."
        -> (한 항목씩 화면 넘기며) "잠시 후 알림 받으시려면 일번,
            ...
            예약 목록을 확인하시려면 사번, 알람 소리를 바꾸시려면 오번."
