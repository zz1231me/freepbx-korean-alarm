...
만들어지는 것 (/var/lib/asterisk/sounds/custom/bank/)
    ...
    d-1~d-4    한 시간 ~ 네 시간      w-1~w-7    월요일 ~ 일요일
    n-1~n-9    일번 ~ 구번            t-*        알람입니다 / 으로 예약했습니다 …
    g-*        인사와 안내 문구
...
GREETINGS = {
    ...
    # --- 메뉴 -----------------------------------------------------------
    # 목적을 먼저, 번호를 끝에 말합니다. "~하시려면 N번" 순서가 전화
    # 안내에서 가장 자연스럽습니다. 끝에 "눌러 주세요"로 키 입력 자리임을
    # 알려 줍니다. 네 항목 모두 "~시려면 N번" 으로 어미를 맞춰 리듬을 고릅니다.
    # 자주 쓰는 "몇 분 후" 를 일번으로 앞당겼습니다.
    # 참고: 예전 gTTS 는 '몇 분' 을 "럽분" 으로 뭉갰습니다. cedar 는 제대로
    #       읽으므로 더 자연스러운 '몇 분 뒤' 로 되돌렸습니다. 목소리를 바꾼
    #       뒤 발음이 이상하면 이 두 줄(g-menu·g-enter-min)만 '얼마 뒤' 로.
    "g-menu":      "몇 분 뒤에 알람을 받으시려면 일번, "
                   "시각을 정해 두시려면 이번, "
                   "반복 알람을 맞추시려면 삼번, "
                   "예약을 확인하거나 삭제하시려면 구번을 눌러 주세요.",
    ...
    "g-enter-min": "몇 분 뒤에 알람을 맞춰 드릴까요? "
                   ...
                   "삼십 분 뒤면 삼공입니다.",
    # 3번 반복은 2단 메뉴입니다.
    #   1단계(g-rep-menu): 평일 / 주말 / 요일별 / 매일 을 번호로 고릅니다.
    #     "평일/주말/매일" 을 한 줄에 몰아 읽으면 잘 안 들려서, 이렇게
    #     "평일 반복은 일번" 처럼 길게 또박또박 말해 명확하게 했습니다.
    "g-rep-menu":  "평일 반복은 일번, 주말 반복은 이번, "
                   "요일별 반복은 삼번, 매일 반복은 사번을 눌러 주세요.",
    ...
    # --- 목록 / 삭제 ------------------------------------------------------
    "g-list":      "예약된 알람입니다.",
    # 한 건씩 들려주고 수정/삭제/다음을 묻습니다.
    "g-item-ask":  "수정하려면 일번, 삭제하려면 이번, 다음은 구번을 눌러 주세요.",
    "g-edit":      "지웠습니다. 다시 설정해 주세요.",
    "g-list-ask":  "삭제할 번호를 눌러 주세요. 전부 삭제하시려면 공번. "
                   "그대로 두시려면 잠시 기다려 주세요.",
    "g-delall":    "예약을 전부 삭제할까요? 삭제하시려면 일번, "
                   "그만두시려면 이번을 눌러 주세요.",
    "g-deleted":   "삭제했습니다.",
    "g-cancelled": "예약을 전부 삭제했습니다.",
    "g-none":      "예약된 알람이 없습니다.",
    "g-more":      "예약이 더 있습니다.",
